...
- **AI Summary:** Generate a concise summary using the Llama 3.3 70B model.
- **Modern UI:** Sleek, dark-mode interface built with React and TypeScript.
...
- [Plasmo HQ](https://www.plasmo.com/) framework installed.
